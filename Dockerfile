...
ADD --link --chown=${SOLR_UID}:${SOLR_GID} https://github.com/dbmdz/solr-ocrhighlighting/releases/download/$SOLR_OCRHIGHLIGHTING_VERSION/solr-ocrhighlighting-$SOLR_OCRHIGHLIGHTING_VERSION-solr78.jar /opt/solr/contrib/ocrhighlighting/lib/
